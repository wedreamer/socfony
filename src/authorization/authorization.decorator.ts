...
export const AuthorizationTokenDecorator = createParamDecorator(function (args: Prisma.AuthorizationTokenArgs, context: ExecutionContext) {
...
export const UserDecorator = createParamDecorator(function (args: Prisma.UserArgs, context: ExecutionContext) {
